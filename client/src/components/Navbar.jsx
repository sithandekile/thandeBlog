...
export default function Navbar() {
  ...
  return (
    <header className="relative bg-sky-950 text-white dark:bg-slate-900 dark:text-gray-100 p-4 shadow-lg flex flex-wrap items-center justify-between gap-3 sticky top-0 left-0 right-0 z-10">
